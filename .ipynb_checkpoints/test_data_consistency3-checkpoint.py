...
class TestDataConsistency:
    ...
    def test_kategorie(self):
        ...
        csv_kategorie = self.csv_data['category'].unique() # Zmiana cls na self
    ...
    def test_filmy(self):
        ...
        csv_filmy = self.csv_data["film"].unique() # Zmiana cls na self
    ...
    def test_typy_nagrod(self):
        ...
        csv_typy_nagrod = self.csv_data["type"].unique() # Zmiana cls na self
    ...
    def test_nagrody_rok(self):
        ...
        csv_lata = self.csv_data["YEAR"].sort_values().unique() # Zmiana cls na self
